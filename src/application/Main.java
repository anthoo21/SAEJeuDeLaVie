...
public class Main extends Application {
	...
	/**
	 * TODO commenter le role (attribut ou r么le associatif)
	 */
	...
	public void start(Stage primaryStage) {
		...
		Label rules = new Label ("R鑗les");
		Label size = new Label ("Taille de la grille");
		Label rulesDie = new Label ("Une cellule na顃 si elle est   entour閑 de : "); // espace pour IHM
		Label rulesLive = new Label ("Une cellule reste en vie si elle est entour閑 de : ");
		...
		rulesLive.setWrapText(true); //  d茅bloque le retour 脿 la ligne
...
//		right.setTranslateY(100);
	...
	/**
	 * TODO commenter le r么le (SRP) de cette m茅thode 
